...
constexpr std::array table{
    ...
    // and is parsed. No browser paints psd, wmf, emf or, since webkit dropped
    // it, jp2; what paints tiff, heic and jxl varies by host.
    ...
    Row{FileType::jpeg_2000,
        ...
        FileCategory::image,
        DocumentType::unknown,
        {.detect_by_content = true, .open = true}},
