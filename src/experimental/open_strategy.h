#ifndef ODR_EXPERIMENTAL_OPEN_STRATEGY_H
#define ODR_EXPERIMENTAL_OPEN_STRATEGY_H
...
namespace odr::experimental::open_strategy {
...
#endif // ODR_EXPERIMENTAL_OPEN_STRATEGY_H
