...
public:
  ...
  [[nodiscard]] virtual experimental::FileLocation
...
public:
  ...
  [[nodiscard]] virtual experimental::FileCategory
  file_category() const noexcept = 0;
  [[nodiscard]] virtual experimental::FileMeta file_meta() const noexcept = 0;
};

class ImageFile : public DecodedFile {
public:
  [[nodiscard]] experimental::FileCategory file_category() const noexcept final;
