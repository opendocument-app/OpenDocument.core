...
TEST(MsCryptoUtil, ECMA376Standard_deriveKey) {
  odr::ooxml::OfficeOpenXmlCrypto::EncryptionHeader encryptionHeader{};
  ...
  odr::ooxml::OfficeOpenXmlCrypto::EncryptionVerifier encryptionVerifier{};
  ...
  odr::ooxml::OfficeOpenXmlCrypto::ECMA376Standard crypto(
      encryptionHeader, encryptionVerifier, "");
...
TEST(MsCryptoUtil, ECMA376Standard_verify) {
  const odr::ooxml::OfficeOpenXmlCrypto::EncryptionHeader encryptionHeader{};
  odr::ooxml::OfficeOpenXmlCrypto::EncryptionVerifier encryptionVerifier{};
